...
### RB-101 Scope-Isolation fuer atomare Task-Slices erzwingen

- JSON: `tem/tasks/open/RB-101.json`
- Track: `governance`
- Match: `all_scope_paths_touched`
- Source: `tem/rebuttals/cf-003-008-cycle-01.md`, `docs/V2/RULES.md`, `tem/WORKFLOW.md`
- Scope: `tem/tasks/open/CF-003.json`, `tem/tasks/open/CF-006.json`, `tem/tasks/open/CF-007.json`, `docs/V2/RULES.md`, `tem/WORKFLOW.md`
- Description: Change-Sets so schneiden, dass jeweils nur ein Task-Scope gematcht wird und off-scope Dateiaenderungen ausgeschlossen sind.

### RB-102 CF-004 Canvas-Migration explizit nachweisen

- JSON: `tem/tasks/open/RB-102.json`
- Track: `canvas-migration`
- Match: `all_scope_paths_touched`
- Source: `tem/rebuttals/cf-003-008-cycle-01.md`, `docs/V2/RULES.md`, `tem/WORKFLOW.md`
- Scope: `app/src/ui/TileGridRenderer.js`, `app/src/ui/UIController.js`, `app/src/ui/RenderManager.js`, `app/public/game.html`, `app/src/ui/tileGrid.css`
- Description: Tile-Primärpfad auf Canvas umstellen und DOM nur als Restadapter/Fallback behalten, inklusive Evidence pro Scope-Datei.

### RB-103 CF-005 Interaction-Overlay Contract einfuehren

- JSON: `tem/tasks/open/RB-103.json`
- Track: `canvas-migration`
- Match: `all_scope_paths_touched`
- Source: `tem/rebuttals/cf-003-008-cycle-01.md`, `docs/V2/RULES.md`, `tem/WORKFLOW.md`
- Scope: `app/src/ui/IconAnimations.js`, `app/src/ui/RenderManager.js`, `app/src/ui/UIController.js`
- Description: Hover/Selection/Effects als expliziten Overlay-State und Render-Contract definieren und gegen Tick/Viewport verifizieren.

### RB-104 CF-006 Koordinatenraum fuer World und Tiles vereinheitlichen

- JSON: `tem/tasks/open/RB-104.json`
- Track: `canvas-migration`
- Match: `all_scope_paths_touched`
- Source: `tem/rebuttals/cf-003-008-cycle-01.md`, `docs/V2/RULES.md`, `tem/WORKFLOW.md`
- Scope: `app/public/game.html`, `app/src/ui/RenderManager.js`, `app/src/ui/UIController.js`
- Description: Gemeinsamen Transform-/Koordinaten-Contract fuer Hintergrund und Tile-Renderpfad herstellen und Layer-Drift ausschliessen.

### RB-105 CF-007 Overlay-Reduktion und Layer-Order absichern

- JSON: `tem/tasks/open/RB-105.json`
- Track: `canvas-migration`
- Match: `all_scope_paths_touched`
- Source: `tem/rebuttals/cf-003-008-cycle-01.md`, `docs/V2/RULES.md`, `tem/WORKFLOW.md`
- Scope: `app/public/game.html`, `app/src/ui/RenderManager.js`, `app/src/ui/UIController.js`
- Description: SVG-Overlay auf Restlinien/Pulseffekte reduzieren und eine harte Layer-Policy fuer Rendering-Ebenen festschreiben.

### RB-106 CF-008 Hit-Testing auf screenToTile umstellen

- JSON: `tem/tasks/open/RB-106.json`
- Track: `canvas-migration`
- Match: `all_scope_paths_touched`
- Source: `tem/rebuttals/cf-003-008-cycle-01.md`, `docs/V2/RULES.md`, `tem/WORKFLOW.md`
- Scope: `app/src/ui/RenderManager.js`, `app/src/ui/UIController.js`
- Description: Pointer-Interaktion von DOM-Rechtecken auf RenderManager-screenToTile migrieren und in UIController zentral verdrahten.
...
### UR-001 Kernel/Game Reachability-Startkette explizit verankern

- JSON: `tem/tasks/open/UR-001.json`
- Track: `unreachable-reduction`
- Match: `all_scope_paths_touched`
- Source: `docs/V2/SYSTEM_PLAN.md`
- Scope: `app/src/sot/repo-boundaries.json`, `app/src/sot/REPO_HYGIENE_MAP.json`, `dev/tools/runtime/repo-hygiene-map.mjs`, `dev/tools/runtime/repo-hygiene-verify.mjs`, `runtime/evidence/unreachable-cause-report.json`
- Description: Beseitigt inbound-but-unreachable Cluster in app/src/kernel und app/src/game durch explizite, testbare Entry-Point-Verankerung oder begruendete Allowlist-Regel mit Sunset.

### UR-002 Runtime-Tooling in invoke-bar vs dead trennen

- JSON: `tem/tasks/open/UR-002.json`
- Track: `unreachable-reduction`
- Match: `all_scope_paths_touched`
- Source: `docs/V2/SYSTEM_PLAN.md`
- Scope: `package.json`, `.githooks/`, `.github/workflows/`, `dev/tools/runtime/`, `app/src/sot/repo-boundaries.json`, `runtime/evidence/unreachable-cause-report.json`
- Description: Klassifiziert dev/tools/runtime Dateien in aktiv aufrufbar (scripts/hooks/ci) oder dead. Dead Paths werden entfernt oder in klaren Archive-Scope verschoben.

### UR-003 Hygiene-Gate fuer non-allowlisted unreachable schaerfen

- JSON: `tem/tasks/open/UR-003.json`
- Track: `unreachable-reduction`
- Match: `all_scope_paths_touched`
- Source: `docs/V2/SYSTEM_PLAN.md`
- Scope: `dev/tools/runtime/repo-hygiene-verify.mjs`, `app/src/sot/repo-boundaries.json`, `docs/V2/RULES.md`, `runtime/evidence/unreachable-cause-report.json`
- Description: Fail-closed Regel einfuehren: non-allowlisted unreachable muessen gegen Zielbudget laufen und bei Verschlechterung blockieren; Ausnahmen nur mit explizitem Eintrag und Sunset.

### UR-004 Unreachable-Cause Evidence in Required-Report integrieren

- JSON: `tem/tasks/open/UR-004.json`
- Track: `unreachable-reduction`
- Match: `all_scope_paths_touched`
- Source: `docs/V2/SYSTEM_PLAN.md`
- Scope: `dev/tools/runtime/run-required-checks.mjs`, `dev/tools/runtime/repo-hygiene-map.mjs`, `runtime/evidence/unreachable-cause-report.json`, `runtime/evidence/required-check-report.json`, `runtime/evidence/governance-proof-manifest.json`
- Description: Ursachenbericht fuer unreachable wird als standardisierte Evidence erzeugt und in die Required-Claim-Kette aufgenommen, damit Drift und Regression maschinenlesbar werden.
